...
class SwinAffine(nn.Module):
    def __init__(self, config):
        ...
        #self.aff_head = nn.Linear(embed_dim*4 * 12*12*13, 100)#(embed_dim*4 * 8*8*8, 100) # Uncomment for lung
        self.aff_head = nn.Linear(embed_dim*4 * 12*10*16, 100)#(embed_dim*4 * 8*8*8, 100) # Uncomment for abdomen
        ...
        self.scl_head = nn.Linear(embed_dim*4 * 12*10*16, 100)#(embed_dim*4 * 8*8*8, 100)
        ...
        self.trans_head = nn.Linear(embed_dim*4 * 12*10*16, 100)#(embed_dim*4 * 8*8*8, 100)
        ...
        self.shear_head = nn.Linear(embed_dim*4 * 12*10*16, 100)#(embed_dim*4 * 8*8*8, 100)
